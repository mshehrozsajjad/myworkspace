...
<head>
  ...
  #okay{
    ...
    $query = "SELECT departmentname,departmentdescription from department where  iddepartment = '$iddepartment';";
    $result=mysql_query($query);	
    if (!$result){
    die("BAD2!");
}
...
<body class="hold-transition skin-red sidebar-mini" ng-app="" ng-init="name='<?php echo $firstName;?>'">
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <li class="treeview">
          <a href="#">
            <a class="fa fa-edit"></i> <span>Terms & Conditions</span>
          </a>
 ...
 <div class="col-sm-12">
    <div class="box box-danger">
      ...
      <div class="row">
        <div class="col-sm-12 text-center" id="Department">
          <div class="row"><h1><?php echo $departmentname;?></h1>
          <hr> </div>
          <div class="row">
          <h4 style="color:Gray;"><?php echo $departmentdescription;?></h4>
          </div>
       ...
       <?php 
                    ...
                    if($canEdit == '1'){ ?>
                    <script>$("#Department").attr("class","col-sm-8 text-center")</script>
          
        <div class="col-sm-2 col-sm-offset-1">
        <a href="newTask.php?projectid=<?php echo $idprojects ?>&departmentid=<?php echo $iddepartment ?>">
          <div class="adduser text-center" style="color:white;">
            ...
            <div class="box-body">
              <div class="container-fluid">
                ...
                $sql ="select * from tasks where idtasks  in (select taskid from user_task ut,websiteusers w, tasks t where t.idtasks=ut.taskid and t.username=ut.username and ut.taskname=t.taskname and ut.user_name=w.username and ut.project_id=t.project_id and ut.dept_id=t.dept_id and ut.user_name='$userName' and ut.project_id='$idprojects'and ut.dept_id='$iddepartment');";
                 ...
                 ?>
                 <a href="tasks.php?projectid=<?php echo $idprojects ?>&departmentid=<?php echo $iddepartment?>&taskid=<?php echo $rws['idtasks'] ?>">
                  <div class="newtask text-center col-sm-12" style="color:black;"id="<?php  echo $rws['idtasks'] ?>-tasks">
                    <div class="col-sm-12 " style="red"><h3><?php echo $rws['taskname']?></h3><hr></div>
                     <h4 style="color:Gray;"><?php echo $rws['taskdescription']?></h4>
                  </div>
                 </a>
                 <?php }?>
