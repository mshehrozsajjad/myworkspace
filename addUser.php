  ...
  <div class="content-wrapper">
    ...
    <div class="box box-success">
      ...
      <div class="col-sm-12">
        ...
        <form class="form-horizontal" role="form" method="post" action="completeAddUser.php"  enctype="multipart/form-data">
      <div class="col-sm-6 ">
        <div class="text-center">
            <label class="control-label" ><h2> <span class="glyphicon glyphicon-tasks"></span> Tasks Name</h2></label></br>
           <select name="departmentid[]"class="selectpicker" data-live-search="true" multiple data-actions-box="true" data-width="100%" data-selected-text-format="count > 2"data-size="4"title="Search by Task Name">
                     <?php
                $sql ="select * from tasks where idtasks  in (select taskid from user_task ut,websiteusers w, tasks t where t.idtasks=ut.taskid and t.username=ut.username and ut.taskname=t.taskname and ut.user_name=w.username and ut.project_id=t.project_id and ut.dept_id=t.dept_id and ut.user_name='$userName' and ut.project_id='$idprojects'and ut.dept_id='$iddepartment');";
                 ...
                 ?>
                    <option value="<?php echo $rws['idtasks'] ?>"><?php echo $rws['taskname']?></option>
                  <?php } ?>
              </select>
      </div>
            <!-- edit form column -->
      ...
      <div class=" col-sm-6  personal-info">
          ...
          <div class="form-group text-center">
            ...
            <label class="control-label" ><h2> <span class="glyphicon glyphicon-user"></span> User Name</h2></label></br>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-offset-3 col-sm-6">
              <button type="submit" class="btn btn-lg btn-block btn-success" name="submit">Add User</button>
              <span></span>
